model TB_model {
    ...
    sub transition (delta = 0.1) {
        ...
        ode {
            ...
            dInf/dt  = - infmin*Inf  - infclr*Inf - infsub*Inf - infclin*Inf;
            dClr/dt  =   infclr*Inf;
	    dRec/dt  =   minrec*Min1 + minrec*Min2 + minrec*Min3;
            ...
            dClin/dt =   sub_clin*Sub1 + sub_clin*Sub2 - clin_sub*Clin - mort*Clin + infclin*Inf;
            dZ_min/dt  =  infmin*Inf;
            dZ_sub/dt  =  infsub*Inf + min_sub*Min1;
            dZ_clin/dt =  infclin*Inf + sub_clin*Sub1;
    ...
    sub proposal_parameter {
        ...
        infclin ~ truncated_gaussian(mean = infclin, std = 0.01, lower = 0, upper = 3)
