model TB_model {
    ...
    sub transition (delta = 0.1) {
        ...
        ode {
            ...
            dInf/dt  = - infmin*Inf  - infclr*Inf - infsub*Inf - infint*Inf;
            dClr/dt  =   infclr*Inf;
	    dRec/dt  =   minrec*Min1 + minrec*Min2 + minrec*Min3;
	    dInt/dt  =   infint*Inf - intmin*Int
            dMin1/dt =   infmin*Inf + intmin*Int - min_sub*Min1 - minrec*Min1;
            ...
            dZ_min/dt  =  infmin*Inf + intmin*Int;
            dZ_sub/dt  =  min_sub*Min1 + infsub*Inf;
    ...
    sub proposal_parameter {
        infclr ~ truncated_gaussian(mean = infclr, std = 0.01, lower = 0, upper = 24)
        infint ~ truncated_gaussian(mean = infint, std = 0.01, lower = 0, upper = 3)
        intmin ~ truncated_gaussian(mean = intmin, std = 0.01, lower = 0, upper = 6)
